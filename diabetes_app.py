...
if st.button("🔍 당뇨 예측하기"):
    ...
    input_data['신체위험도'] = input_data['체질량지수'] + input_data['혈압']
    input_data['비만혈당지수'] = input_data['체질량지수'] * input_data['포도당(혈당)']
    input_data['임신_나이_비율'] = input_data['임신횟수'] / (input_data['나이'] + 1)
    input_data['건강취약'] = (input_data['나이'] * input_data['체질량지수']) / 100
    ...
    if predicted[0] == 0:
        ...
        st.error("⚠️ 당뇨 위험 가능성이 있습니다!")import streamlit as st
import pandas as pd
import joblib
